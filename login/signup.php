...
<section class="container">
    <section class="signup-form">
        <form method="post" action="" role="login" enctype="multipart/form-data" id="signupForm" name="signupForm">
            ...
            <br> Date Of Birth
            <input type="text" name="user_dob" required class="form-control input-lg"
                   id="dob">
            <br>
            ...
            <input type="submit" name="regBtn" class="btn btn-lg btn-primary btn-block" value="SignUp" id="submitbtn"/>
            <div>
